...
@section('body')
    ...
    <div class="banner1">
        <div class="container">
            <h3><a href="index.html">Home</a> / <span>Brands</span></h3>
        </div>
    </div>
    <!--banner-->
    <!--content-->
                                            ...
                                            @foreach($brandProducts as $brandProduct)
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            <h6>
                                                                <a href="{{route('product-details',['id' => $brandProduct -> id , 'name' => $brandProduct -> product_name])}}">{{$brandProduct -> product_name}}</a>
                                                            </h6>
                                                            <p>
                                                                <em class="item_price">TK. {{$brandProduct -> product_price}}</em>
                                                            </p>
                                                            <form action="{{route('add-to-cart')}}" method="post">
                                                                @csrf
                                                                <input type="hidden" name="qty" value="1" min="1"/>
                                                                <input type="hidden" name="product_id" value=" {{$brandProduct -> id}}"/>
                                                        ...
                                                        <div class="grid-arrival">
                                                            <figure>
                                                                <a href="{{route('product-details',['id' => $brandProduct -> id, 'name' => $brandProduct -> product_name])}}" class="new-gri">
                                                                    ...
                                                                    <div class="grid-img">
                                                                        <img src="{{ asset($brandProduct -> product_name) }}"
                                                                             class="img-responsive" alt="">
                                                                    </div>
                                                                </a>
                                                            </figure>
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        ...
                                                        <p>
                                                            ...
                                                            <em class="item_price">TK. {{$brandProduct -> product_price}}</em></p>
                                                        <form action="{{route('add-to-cart')}}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="qty" value="1" min="1"/>
                                                            <input type="hidden" name="product_id" value=" {{$brandProduct -> id}}"/>
