                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            <p>
                                                                <em class="item_price">TK. {{$categoryProduct -> product_price}}</em>
                                                            </p>
                                                        ...
                                                        <div class="grid-arrival">
                                                            <figure>
                                                                <a href="{{route('product-details',['id' => $categoryProduct -> id ,'name' =>$categoryProduct -> product_name])}}" class="new-gri">
                                                                    ...
                                                                    <div class="grid-img">
                                                                        <img src="{{ asset($categoryProduct -> product_name) }}"
                                                                             class="img-responsive" alt="">
                                                                    </div>
                                                                </a>
                                                            </figure>
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        ...
                                                        <p>
                                                            ...
                                                            <em class="item_price">TK. {{$categoryProduct -> product_price}}</em></p>
                                                        <form action="{{route('add-to-cart')}}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="qty" value="1" min="1"/>
                                                            <input type="hidden" name="product_id" value=" {{$categoryProduct -> id}}"/>
